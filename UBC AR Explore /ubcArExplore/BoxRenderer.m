...
- (void)init_ {
    ...
    const GLubyte cube_vertex_colors_2[8][4] = {
        ...
        {0, 128, 255, 128}, {0, 128, 255, 128}, {0, 128, 255, 128}, {0, 128, 255, 128},
        {255, 0, 255, 0}, {255, 255, 255, 0}, {0, 255, 255, 0}, {255, 0, 255, 0}};
...
- (void)render:(easyar_Matrix44F *)projectionMatrix cameraview:(easyar_Matrix44F *)cameraview size:(easyar_Vec2F *)size {
    ...
    const GLfloat cube_vertices_2[8][3] = {
        /* +z */{size0 / 2, size1 / 2, size0 / 2},{size0 / 2, -size1 / 2, size0 / 2},{-size0 / 2, -size1 / 2, size0 / 2},{-size0 / 2, size1 / 2, size0 / 2},
